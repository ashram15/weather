...
The website uses a weather API and sends a HTTP request to the website which then returns a dataset in Javascript. The program parses this data and displays the weather in Fahrenheit, the conditions, and a small icon displaying the conditions of the user's locaiton on the website. 
